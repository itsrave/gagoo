          ...
          <Col lg={8}>
            <Card.Body>
              <Row>
                ...
                {/*        plaintext={true}*/}
                {/*        readOnly={true}*/}
                {/*        value={this.props.description.split("<br />").join("")}*/}
                {/*      />*/}
                {/*    </Form.Group>*/}
                {/*  </Form>*/}
                {/*</Col>*/}
                <Col sm={4}>
                  <Row>
                    <Col className={'text-center my-1'}>
                      <Button variant="success" disabled={this.state.successAccept} onClick={this.acceptOffer} block>Akceptuj</Button>
                    </Col>
                  </Row>
                  <Row>
                    <Col className={'text-center my-1'}>
                      <Button variant="danger" disabled={this.state.successAccept} onClick={this.deleteOffer} block>Usuń</Button>
                    </Col>
                  </Row>
                  <Row>
                    <Col className={'text-center my-1'}>
