    ...
    return (
      <Container>
        <Nav variant="tabs">
          <Nav.Item>
            <Nav.Link
              onClick={this.toggleOffersActive}
              className={this.state.offersActive ? 'active' : null}
            >
              Moje ogłoszenia
            </Nav.Link>
          </Nav.Item>
          <Nav.Item>
            <Nav.Link
              onClick={this.toggleSettingsActive}
              className={this.state.settingsActive ? 'active' : null}
            >
              Ustawienia
            </Nav.Link>
          </Nav.Item>
