          ...
          <Card.Body>
            <Card.Title>
              <Row>
                ...
                <Col xs={8}>{DOMPurify.sanitize(this.state.userData.name)}</Col>
              </Row>
            </Card.Title>
            <Row>
              <Col xs={1}><FontAwesomeIcon icon={faMapMarker}/></Col>
              <Col xs={8}>{DOMPurify.sanitize(this.state.userData.city)}</Col>
            </Row>
          </Card.Body>
          <ListGroup className="list-group-flush">
            ...
            <ListGroupItem>
              <Row>
                ...
                <Col xs={8}>{DOMPurify.sanitize(this.state.userData.phoneNumber)}</Col>
              </Row>
            </ListGroupItem>
            <ListGroupItem>
              <Row>
                <Col xs={1}><FontAwesomeIcon icon={faEnvelope} /></Col>
                <Col xs={10}>{DOMPurify.sanitize(this.state.userData.email)}</Col>
              </Row>
            </ListGroupItem>
          </ListGroup>
        </Card>
